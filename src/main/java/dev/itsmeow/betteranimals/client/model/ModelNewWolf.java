...
public class ModelNewWolf<T extends LivingEntity> extends Model<T> {
    ...
    @Override
    public void setRotationAngles(T entity, float limbSwing, float limbSwingAmount, float tailRotation, float netHeadYaw, float headPitch) {
        float swingModifier = 0.9f;
        this.head.rotateAngleY = rad(netHeadYaw);
        this.head.rotateAngleX = rad(headPitch) + 2.1816615649929116F;
