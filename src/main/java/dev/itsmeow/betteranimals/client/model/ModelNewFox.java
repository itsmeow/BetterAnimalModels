...
public class ModelNewFox<T extends LivingEntity> extends Model<T> {
    ...
    public ModelNewFox() {
        ...
        this.tail02b = new ModelRenderer(this, 0, 45);
        ...
        this.lowerJaw = new ModelRenderer(this, 23, 48);
        ...
        this.tail02d = new ModelRenderer(this, 0, 45);
        ...
        this.upperJawL = new ModelRenderer(this, 34, 43);
        ...
        this.upperJawR = new ModelRenderer(this, 34, 43);
    ...
    public void setRotationAngles(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if(entity instanceof FoxEntity) {
            ...
            if(fox.isCrouching()) {
                this.lArm01.rotationPointY = 0.1F - 1F;
                this.rArm01.rotationPointY = 0.1F - 1F;
                this.lHindLeg01.rotationPointY = 0.2F - 1F;
                this.rHindLeg01.rotationPointY = 0.2F - 1F;
                this.body.rotationPointY = 14.1F + 1F;
            } else {
                this.lArm01.rotationPointY = 0.1F;
                this.rArm01.rotationPointY = 0.1F;
                this.lHindLeg01.rotationPointY = 0.2F;
                this.rHindLeg01.rotationPointY = 0.2F;
                this.body.rotationPointY = 14.1F;
            }
