...
/**
 * ovisatre - cybercat5555 Created using Tabula 6.0.0
 */
public class ModelNewOvisAtre extends Model {
	...
	public ModelNewOvisAtre() {
		...
		this.lHorn01b = new ModelRenderer(this, 0, 25);
		this.lHorn01b.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.lHorn01b.addBox(-0.2F, -0.2F, -3.0F, 1, 1, 3, 0.0F);
		...
		this.lHorn04 = new ModelRenderer(this, 5, 32);
		this.lHorn04.setRotationPoint(0.0F, 0.0F, -1.8F);
		this.lHorn04.addBox(-0.5F, -0.5F, -2.0F, 1, 1, 2, 0.0F);
		this.setRotateAngle(lHorn04, -0.091106186954104F, -0.18203784098300857F, 0.0F);
		...
		this.rHorn01d = new ModelRenderer(this, 0, 25);
		this.rHorn01d.mirror = true;
		this.rHorn01d.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.rHorn01d.addBox(-0.2F, -0.8F, -3.0F, 1, 1, 3, 0.0F);
		...
		this.rHorn02a = new ModelRenderer(this, 0, 30);
		this.rHorn02a.mirror = true;
		this.rHorn02a.setRotationPoint(0.0F, 0.0F, -2.5F);
		this.rHorn02a.addBox(-0.7F, -0.3F, -2.0F, 1, 1, 2, 0.0F);
		this.setRotateAngle(rHorn02a, -0.136659280431156F, 0.136659280431156F, 0.0F);
		this.rHorn01b = new ModelRenderer(this, 0, 25);
		this.rHorn01b.mirror = true;
		this.rHorn01b.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.rHorn01b.addBox(-0.2F, -0.2F, -3.0F, 1, 1, 3, 0.0F);
		this.neck01 = new ModelRenderer(this, 0, 12);
		this.neck01.setRotationPoint(0.0F, -0.6F, -4.5F);
		this.neck01.addBox(-3.0F, -3.0F, -5.0F, 6, 6, 5, 0.0F);
		this.setRotateAngle(neck01, -0.5918411493512771F, 0.0F, 0.0F);
		...
		this.lForeHoof = new ModelRenderer(this, 55, 29);
		this.lForeHoof.setRotationPoint(0.1F, 6.5F, 0.0F);
		this.lForeHoof.addBox(-1.5F, 0.0F, -1.5F, 3, 2, 2, 0.0F);
		this.lHorn03 = new ModelRenderer(this, 5, 32);
		this.lHorn03.setRotationPoint(0.0F, 0.0F, -1.6F);
		this.lHorn03.addBox(-0.5F, -0.5F, -2.0F, 1, 1, 2, 0.0F);
		this.setRotateAngle(lHorn03, -0.091106186954104F, -0.091106186954104F, 0.0F);
		this.lHorn02c = new ModelRenderer(this, 0, 30);
		this.lHorn02c.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.lHorn02c.addBox(-0.7F, -0.7F, -2.0F, 1, 1, 2, 0.0F);
		...
		this.rHorn02b = new ModelRenderer(this, 0, 30);
		this.rHorn02b.mirror = true;
		this.rHorn02b.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.rHorn02b.addBox(-0.3F, -0.3F, -2.0F, 1, 1, 2, 0.0F);
		this.rHorn01c = new ModelRenderer(this, 0, 25);
		this.rHorn01c.mirror = true;
		this.rHorn01c.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.rHorn01c.addBox(-0.8F, -0.8F, -3.0F, 1, 1, 3, 0.0F);
		...
		this.rHorn04 = new ModelRenderer(this, 5, 32);
		this.rHorn04.mirror = true;
		this.rHorn04.setRotationPoint(0.0F, 0.0F, -1.8F);
		this.rHorn04.addBox(-0.5F, -0.5F, -2.0F, 1, 1, 2, 0.0F);
		this.setRotateAngle(rHorn04, -0.091106186954104F, 0.18203784098300857F, 0.0F);
		...
		this.lHorn05 = new ModelRenderer(this, 5, 32);
		this.lHorn05.setRotationPoint(0.0F, 0.0F, -1.8F);
		this.lHorn05.addBox(-0.5F, -0.5F, -2.0F, 1, 1, 2, 0.0F);
		this.setRotateAngle(lHorn05, 0.045553093477052F, 0.18203784098300857F, 0.0F);
		...
		this.rHorn02d = new ModelRenderer(this, 0, 30);
		this.rHorn02d.mirror = true;
		this.rHorn02d.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.rHorn02d.addBox(-0.3F, -0.7F, -2.0F, 1, 1, 2, 0.0F);
		this.lArmWool01_1 = new ModelRenderer(this, 64, 47);
		this.lArmWool01_1.setRotationPoint(0.0F, 1.3F, 0.0F);
		this.lArmWool01_1.addBox(-1.5F, -2.0F, -1.5F, 3, 5, 3, 0.0F);
		this.rArmWool01_1 = new ModelRenderer(this, 64, 47);
		this.rArmWool01_1.mirror = true;
		this.rArmWool01_1.setRotationPoint(0.0F, 1.3F, 0.0F);
		this.rArmWool01_1.addBox(-1.5F, -2.0F, -1.5F, 3, 5, 3, 0.0F);
		...
		this.lHorn01a = new ModelRenderer(this, 0, 25);
		this.lHorn01a.setRotationPoint(1.5F, 1.5F, -1.2F);
		this.lHorn01a.addBox(-0.8F, -0.2F, -3.0F, 1, 1, 3, 0.0F);
		this.setRotateAngle(lHorn01a, -0.5918411493512771F, -0.22759093446006054F, 0.0F);
		this.rHindHoof = new ModelRenderer(this, 55, 29);
		...
		this.lHindHoof = new ModelRenderer(this, 55, 29);
		...
		this.rHorn01a = new ModelRenderer(this, 0, 25);
		this.rHorn01a.mirror = true;
		this.rHorn01a.setRotationPoint(-1.5F, 1.5F, -1.2F);
		this.rHorn01a.addBox(-0.8F, -0.2F, -3.0F, 1, 1, 3, 0.0F);
		this.setRotateAngle(rHorn01a, -0.5918411493512771F, 0.22759093446006054F, 0.0F);
		this.lHorn01d = new ModelRenderer(this, 0, 25);
		this.lHorn01d.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.lHorn01d.addBox(-0.2F, -0.8F, -3.0F, 1, 1, 3, 0.0F);
		...
		this.lHorn01c = new ModelRenderer(this, 0, 25);
		this.lHorn01c.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.lHorn01c.addBox(-0.8F, -0.8F, -3.0F, 1, 1, 3, 0.0F);
		this.rHorn02c = new ModelRenderer(this, 0, 30);
		this.rHorn02c.mirror = true;
		this.rHorn02c.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.rHorn02c.addBox(-0.7F, -0.7F, -2.0F, 1, 1, 2, 0.0F);
		...
		this.lHorn02a = new ModelRenderer(this, 0, 30);
		this.lHorn02a.setRotationPoint(0.0F, 0.0F, -2.5F);
		this.lHorn02a.addBox(-0.7F, -0.3F, -2.0F, 1, 1, 2, 0.0F);
		this.setRotateAngle(lHorn02a, -0.136659280431156F, -0.136659280431156F, 0.0F);
		...
		this.udder = new ModelRenderer(this, 39, 30);
		this.udder.setRotationPoint(0.0F, 3.5F, 4.1F);
		this.udder.addBox(-2.0F, 0.0F, -2.5F, 4, 2, 5, 0.0F);
		this.setRotateAngle(udder, 0.136659280431156F, 0.0F, 0.0F);
		this.lHorn02d = new ModelRenderer(this, 0, 30);
		this.lHorn02d.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.lHorn02d.addBox(-0.3F, -0.7F, -2.0F, 1, 1, 2, 0.0F);
		this.rForeHoof = new ModelRenderer(this, 55, 29);
		...
		this.rHorn03 = new ModelRenderer(this, 5, 32);
		this.rHorn03.mirror = true;
		this.rHorn03.setRotationPoint(0.0F, 0.0F, -1.6F);
		this.rHorn03.addBox(-0.5F, -0.5F, -2.0F, 1, 1, 2, 0.0F);
		this.setRotateAngle(rHorn03, -0.091106186954104F, 0.091106186954104F, 0.0F);
		this.lHorn02b = new ModelRenderer(this, 0, 30);
		this.lHorn02b.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.lHorn02b.addBox(-0.3F, -0.3F, -2.0F, 1, 1, 2, 0.0F);
		this.rHorn05 = new ModelRenderer(this, 5, 32);
		this.rHorn05.mirror = true;
		this.rHorn05.setRotationPoint(0.0F, 0.0F, -1.8F);
		this.rHorn05.addBox(-0.5F, -0.5F, -2.0F, 1, 1, 2, 0.0F);
		this.setRotateAngle(rHorn05, 0.045553093477052F, -0.18203784098300857F, 0.0F);
		...
		this.lArm02.addChild(this.lArmWool01_1);
		this.rArm02.addChild(this.rArmWool01_1);
		...
		this.neck01.addChild(this.wool03);
		...
		this.flank.addChild(this.udder);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		this.body.render(f5);
		if(entity instanceof EntityOvisAtre) {
			if (((EntityOvisAtre) entity).getSheared()) {
