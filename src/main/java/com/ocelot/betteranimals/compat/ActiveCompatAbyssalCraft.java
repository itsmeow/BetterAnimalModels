...
public class ActiveCompatAbyssalCraft implements ModInteropProxy {
	...
	public void register() {
		...
		if(BetterAnimalsConfig.enableDemonChicken)
			CompatUtils.reg(EntityDemonChicken.class, new RenderNewEvilChicken(new ResourceLocation(BetterAnimals.MODID, "textures/mobs/abyssalcraft/demon_chicken.png")));
