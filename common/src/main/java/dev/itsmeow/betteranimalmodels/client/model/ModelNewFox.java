...
public class ModelNewFox<T extends LivingEntity> extends Model<T> {
    ...
    public ModelNewFox(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition lHindpaw = lHindLeg03.addOrReplaceChild("lHindpaw", CubeListBuilder.create().texOffs(32, 28).mirror().addBox(-1.5F, -0.5F, -2.3F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 4.6F, 0.0F));
        ...
        PartDefinition rHindpaw = rHindLeg03.addOrReplaceChild("rHindpaw", CubeListBuilder.create().texOffs(32, 28).addBox(-1.5F, -0.5F, -2.3F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 4.6F, 0.0F));
        ...
        PartDefinition tail02b = tail02a.addOrReplaceChild("tail02b", CubeListBuilder.create().texOffs(0, 45).mirror().addBox(-0.3F, -1.7F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));
        PartDefinition tail02c = tail02a.addOrReplaceChild("tail02c", CubeListBuilder.create().texOffs(0, 45).addBox(-1.69F, -0.3F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        PartDefinition tail02d = tail02a.addOrReplaceChild("tail02d", CubeListBuilder.create().texOffs(0, 45).mirror().addBox(-0.31F, -0.3F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition tail05 = tail04.addOrReplaceChild("tail05", CubeListBuilder.create().texOffs(36, 53).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0349F, 0.0F, 0.0F));
        ...
        PartDefinition lForepaw = lArm02.addOrReplaceChild("lForepaw", CubeListBuilder.create().texOffs(32, 28).mirror().addBox(-1.5F, -0.9F, -2.3F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 6.5F, 0.0F));
        ...
        PartDefinition rForepaw = rArm02.addOrReplaceChild("rForepaw", CubeListBuilder.create().texOffs(32, 28).addBox(-1.5F, -0.9F, -2.3F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 6.5F, 0.0F));
        ...
        PartDefinition snoot = head.addOrReplaceChild("snoot", CubeListBuilder.create().texOffs(23, 43).addBox(-1.0F, -1.0F, -2.4F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.7F, -4.0F, 0.2276F, 0.0F, 0.0F));
        PartDefinition lowerJaw = head.addOrReplaceChild("lowerJaw", CubeListBuilder.create().texOffs(23, 48).addBox(-1.0F, -0.6F, -2.6F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.5F, -3.7F));
        PartDefinition upperJawL = head.addOrReplaceChild("upperJawL", CubeListBuilder.create().texOffs(34, 43).addBox(-1.0F, -0.5F, -2.5F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.4F, 0.9F, -3.9F, 0.0F, 0.1396F, -0.0873F));
        PartDefinition upperJawR = head.addOrReplaceChild("upperJawR", CubeListBuilder.create().texOffs(34, 43).mirror().addBox(-1.0F, -0.5F, -2.5F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.4F, 0.9F, -3.9F, 0.0F, -0.1396F, 0.0873F));
        ...
        PartDefinition lEar02 = lEar01.addOrReplaceChild("lEar02", CubeListBuilder.create().texOffs(21, 5).mirror().addBox(-0.5F, -1.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.015F)).mirror(false), PartPose.offsetAndRotation(0.5F, -1.7F, 0.0F, 0.0F, 0.0F, -0.4363F));
        PartDefinition lEar03 = lEar01.addOrReplaceChild("lEar03", CubeListBuilder.create().texOffs(29, 0).mirror().addBox(-0.5F, -3.7F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.5F, 0.8F, 0.2269F, 0.0F, 0.0F));
        PartDefinition lEar04 = lEar01.addOrReplaceChild("lEar04", CubeListBuilder.create().texOffs(21, 5).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.01F)), PartPose.offsetAndRotation(-0.5F, -1.7F, 0.0F, 0.0F, 0.0F, 0.4363F));
        ...
        PartDefinition rEar02 = rEar01.addOrReplaceChild("rEar02", CubeListBuilder.create().texOffs(21, 5).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.015F)), PartPose.offsetAndRotation(-0.5F, -1.7F, 0.0F, 0.0F, 0.0F, 0.4363F));
        PartDefinition rEar03 = rEar01.addOrReplaceChild("rEar03", CubeListBuilder.create().texOffs(29, 0).addBox(-0.5F, -3.7F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.5F, 0.8F, 0.2269F, 0.0F, 0.0F));
        PartDefinition rEar04 = rEar01.addOrReplaceChild("rEar04", CubeListBuilder.create().texOffs(21, 5).mirror().addBox(-0.5F, -1.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.01F)).mirror(false), PartPose.offsetAndRotation(0.5F, -1.7F, 0.0F, 0.0F, 0.0F, -0.4363F));
        PartDefinition lCheekFur = head.addOrReplaceChild("lCheekFur", CubeListBuilder.create().texOffs(0, 0).addBox(-0.1F, -1.0F, 0.0F, 3.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.9F, -0.5F, -1.4F, 0.0F, -0.4014F, -0.2618F));
        PartDefinition rCheekFur = head.addOrReplaceChild("rCheekFur", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-2.9F, -1.0F, 0.0F, 3.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.9F, -0.5F, -1.4F, 0.0F, 0.4014F, 0.2618F));
        PartDefinition fur01 = neck.addOrReplaceChild("fur01", CubeListBuilder.create().texOffs(47, 20).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.7F, -1.5F, -0.8652F, 0.0F, 0.0F));
        PartDefinition fur02 = neck.addOrReplaceChild("fur02", CubeListBuilder.create().texOffs(46, 27).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.5F, -0.5F, -0.7741F, 0.0F, 0.0F));
