...
public class ModelNewBear<T extends PolarBear> extends Model<T> {
    ...
    public void renderToBuffer(PoseStack matrixStackIn, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
        this.hind.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
    }

    @Override
    public void setupAnim(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.lArm01.xRot = Mth.cos(limbSwing * 0.6662F) * limbSwingAmount + 0.18203784098300857F;
        this.rArm01.xRot = Mth.cos(limbSwing * 0.6662F + (float) Math.PI) * limbSwingAmount + 0.18203784098300857F;
        this.rLeg01.xRot = Mth.sin(limbSwing * 0.6662F) * limbSwingAmount - 0.136659280431156F;
        this.lLeg01.xRot = Mth.sin(limbSwing * 0.6662F + (float) Math.PI) * limbSwingAmount - 0.136659280431156F;
        this.neck.xRot = rad(headPitch);
