...
public class ModelNewSheep<T extends Sheep> extends Model<T> {
    ...
    public ModelNewSheep(ModelPart root) {
        ...
        this.lForelegWool = lForeleg01.getChild("lForelegWool");
        this.lForelegWool02 = lForelegWool.getChild("lForelegWool02");
        ...
        this.rForelegWool = rForeleg01.getChild("rForelegWool");
        this.lForelegWool3 = rForelegWool.getChild("lForelegWool3");
        ...
        this.woolHead01 = head.getChild("woolHead01");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition lForelegWool = lForeleg01.addOrReplaceChild("lForelegWool", CubeListBuilder.create().texOffs(16, 51).addBox(-0.6F, -2.3F, -2.1F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        PartDefinition lForelegWool02 = lForelegWool.addOrReplaceChild("lForelegWool02", CubeListBuilder.create().texOffs(16, 58).addBox(-2.01F, -0.1F, -2.1F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.9F, 6.8F, 0.6F, -0.0873F, 0.0F, -0.0698F));
        ...
        PartDefinition rForelegWool = rForeleg01.addOrReplaceChild("rForelegWool", CubeListBuilder.create().texOffs(16, 51).mirror().addBox(-3.4F, -2.3F, -2.1F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));
        PartDefinition lForelegWool3 = rForelegWool.addOrReplaceChild("lForelegWool3", CubeListBuilder.create().texOffs(16, 58).mirror().addBox(-0.99F, -0.1F, -2.1F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.9F, 6.8F, 0.6F, -0.0873F, 0.0F, 0.0698F));
        ...
        PartDefinition woolHead01 = head.addOrReplaceChild("woolHead01", CubeListBuilder.create().texOffs(14, 52).addBox(-3.0F, -3.0F, -1.5F, 6.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.3F, -0.1F));
        PartDefinition woolNeck = neck.addOrReplaceChild("woolNeck", CubeListBuilder.create().texOffs(13, 50).addBox(-2.5F, -3.5F, -3.0F, 5.0F, 6.0F, 6.0F, new CubeDeformation(0.2F)), PartPose.offset(0.0F, 0.5F, -1.9F));
    ...
    public void renderToBuffer(PoseStack matrixStackIn, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
        ...
        this.lForelegWool.visible = !sheared;
        this.lForelegWool02.visible = !sheared;
        this.rForelegWool.visible = !sheared;
        this.lForelegWool3.visible = !sheared;
